...
window.Typekit.config = {
    "a": "569718",
    "c": [".tk-baskerville-urw", "\"baskerville-urw\",sans-serif", ".tk-clarendon-text-pro",
        "\"clarendon-text-pro\",sans-serif"],
    "fi": [12051, 24323, 24324],
    "fc": [{
        "id": 12051,
        "family": "baskerville-urw",
        "src": "https://use.typekit.net/af/a04e51/00000000000000003b9acb60/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "400",
            "style": "italic",
        ...
        "src": "https://use.typekit.net/af/c446f8/000000000000000000015670/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "400",
            "style": "normal",
        ...
        "id": 24324,
        "family": "clarendon-text-pro",
        "src": "https://use.typekit.net/af/ed3433/000000000000000000015671/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "400",
            "style": "italic",
            "primer": "7ceb210e49ade74e23101e10f006f110a0b6588c7c57777a6e3d98a38b749696"
...
(function (window, document, undefined) {
    ...
    var ha = [2449897292, 4218179547, 2675077685, 1031960064, 1478620578, 1386343184, 3194259988, 2656050674,
    ...
    ga.prototype.has = function (a) {
        ...
        for (var b = "number" === typeof a, c = 0; c < this.i; c++) {
            var d;
            if (b) d = q(a & 4294967295, 3432918353), d = d << 15 | d >>> 17, d = q(d, 461845907), d ^= ha[c] ||
                0, d = d << 13 | d >>> 19, d = q(d, 5) + 3864292196, d ^= 4, d ^= d >>> 16, d = q(d, 2246822507),
                d ^= d >>> 13, d = q(d, 3266489909), d ^= d >>> 16, d = (d >>> 0) % this.b;
            else {
                d = ha[c] || 0;
                var e, f, g = a.length % 4,
                    k = a.length - g;
                for (f = 0; f < k; f += 4) e = (a.charCodeAt(f + 0) & 4294967295) << 0 | (a.charCodeAt(f + 1) &
                        4294967295) << 8 | (a.charCodeAt(f + 2) & 4294967295) << 16 | (a.charCodeAt(f + 3) &
                        4294967295) << 24, e = q(e, 3432918353), e = e << 15 | e >>> 17, e = q(e, 461845907), d ^=
                    e, d = d << 13 | d >>> 19, d = q(d, 5) + 3864292196;
                e = 0;
                switch (g) {
                    case 3:
                    ...
                    case 1:
                        e ^= (a.charCodeAt(f + 0) & 4294967295) << 0, e = q(e, 3432918353), e = e << 15 | e >>>
                            17, e = q(e, 461845907), d ^= e
                }
                d ^= a.length;
    ...
    function ia(a) {
        ...
        if (window.atob) a = window.atob(a);
            ...
            for (var b = 0, c, d, e = 0, f = ""; d = a.charAt(e++); ~d && (c = b % 4 ? 64 * c + d : d, b++ % 4) ? f +=
                String.fromCharCode(255 & c >> (-2 * b & 6)) : 0) d =
    ...
    ia.prototype.has = function (a) {
        ...
        for (a = a.split("."); a.length;) {
            var b = a.join("."),
                c = "*." + b;
            if (this.b.has(b) || this.b.has(c) || this.b.has(encodeURIComponent(b)) || this.b.has(
    ...
    function ja(a, b) {
        a.b.body ? b() : a.b.addEventListener ? a.b.addEventListener("DOMContentLoaded", b) : a.b.attachEvent(
            "onreadystatechange",
            function () {
    ...
    function x(a, b) {
        ...
        c.styleSheet ? (u(a, "head", c), c.styleSheet.cssText = b) : (c.appendChild(document.createTextNode(b)), u(
            a, "head", c))
    }
        ...
        if (d) {
            ...
            e.onload = e.onreadystatechange = function () {
                f || this.readyState && "loaded" != this.readyState && "complete" != this.readyState || (f = !0,
                    c && c(null), e.onload = e.onreadystatechange = null, "HEAD" == e.parentNode.tagName &&
                    d.removeChild(e))
            };
            d.appendChild(e);
            setTimeout(function () {
    ...
    function oa() {
        ...
        if (/MSIE|Trident/.test(b) && (a.documentMode ? 9 > a.documentMode : 1)) b = "i";
            ...
            a: {
                if (/AppleWebKit/.test(b) && /Android/.test(b) && !/OPR|Chrome|CrMo|CriOS/.test(b) && (a =
                        /Android ([^;)]+)/.exec(b)) && a[1]) {
                    a = parseFloat(a[1]);
                    a = 3.1 <= a && 4.1 > a;
                    break a
    ...
    function H(a, b) {
        return a.b.replace(/\{([^\{\}]+)\}/g, function (a, d) {
            if ("?" == d.charAt(0)) {
                for (var e = d.slice(1).split(","), f = [], g = 0; g < e.length; g++) b[e[g]] && f.push(e[g] +
                    "=" + encodeURIComponent(b[e[g]]));
    ...
    function N(a) {
        return "display:block !important;position:absolute !important;top:-9999px !important;left:-9999px !important;font-size:300px !important;width:auto !important;height:auto !important;line-height:normal !important;margin:0 !important;padding:0 !important;font-variant:normal !important;white-space:nowrap !important;font-family:" +
            a.b + " !important;font-weight:" + a.weight + " !important;font-style:" + a.style + " !important;"
    };
    ...
    function za(a) {
        ...
        d ? l() - a.F >= a.I ? ya() && Aa(a, b, c) && (!a.A || a.A.hasOwnProperty(a.b.b)) ? Ba(a, a.D) : Ba(a, a.H) :
            Ca(a) : Ba(a, a.D)
    }
    ...
    Da.prototype.start = function () {
        var a = this.m.g.document,
            ...
            d = new Promise(function (d, e) {
                function k() {
                    l() - c >= b.g ? e() : a.fonts.load(b.b.style + " " + b.b.weight + " 300px " + (b.j ? E(
                        b.b) : b.b.b), b.o).then(function (a) {
            ...
            J(b, function (b) {
                ...
                if (null === Q)
                    if (window.FontFace) {
                        ...
                        Q = e ? 42 < parseInt(e[1], 10) : pa && /Apple/.exec(window.navigator.vendor) ? 603 <=
                            parseInt(pa[1], 10) : !0
                    } else Q = !1;
                Q ? c = new Da(h(a.i, a), h(a.j,
                        a), a.w, b, a.A, "BESbswy\ue000\ue001\ue002\ue003\ue004\ue005\ue006", a.u) : c =
                    new wa(h(a.i, a), h(a.j, a), a.w, b, a.A, d,
                        "BESbswy\ue000\ue001\ue002\ue003\ue004\ue005\ue006", a.u);
                f.push(c)
            });
    ...
    Ea.prototype.i = function (a) {
        var b = this.b;
        b.i && w(b.g, [b.b.b("wf", a.b, D(a), "active")], [b.b.b("wf", a.b, D(a), "loading"), b.b.b("wf", a.b,
            D(a), "inactive")]);
        C(b, "fontactive", a);
        this.o = !0;
        Ga(this)
    ...
    function Ga(a) {
        !--a.g && a.m && (a.o ? (a = a.b, a.i && w(a.g, [a.b.b("wf", "active")], [a.b.b("wf", "loading"), a.b.b(
            "wf", "inactive")]), C(a, "active")) : B(a.b))
    };
    ...
    var Ha = null,
        S =
        "00000000000000003b9b12ea 00000000000000003b9b12ed 00000000000000003b9b12ef 00000000000000003b9b12f0 00000000000000003b9b12f2 00000000000000003b9b12f3"
        .split(" ");

    function Ia() {
        null === Ha && (Ha = window.CSS && window.CSS.supports && CSS.supports("font-variation-settings",
            '"wght" 400'));
        return Ha
    }
    ...
    R.prototype.load = function (a, b, c) {
        ...
        if (this.j && (a = location.hostname, !this.j.has(a))) {
            console.error('Typekit: the domain "' + a + '" isn\'t in the list of published domains for kit "' +
                this.w + '".');
            B(new A(this.b, c, {}));
            return
        }
            ...
            active: function () {
                ...
                if (d.m) {
                    var a = d.m,
                        b = d.b,
                        c = a.m,
                        k = (window.__adobewebfontsappname__ || a.app || "").toString().substr(0,
                            20),
                        b = b.g.location.hostname || b.i.location.hostname,
                        p = [],
                        y = [];
                    window.Typekit ? (window.Typekit.fonts || (window.Typekit.fonts = []), y =
                        window.Typekit.fonts) : window.TypekitPreview && (window.TypekitPreview
                        .fonts || (window.TypekitPreview.fonts = []), y = window.TypekitPreview
                        .fonts);
    ...
    function Ua(a, b) {
        ...
        for (var e = 0; e < c.length; e++)
            if (c[e].family === a && c[e].descriptors.weight === d.weight && c[e].descriptors.style === d.style &&
                ...
                if (!window.XDomainRequest) {
                    ...
                    a.onload = function () {
                        for (var a = !1, b = 0; b < document.styleSheets.length; b++)
                            if (null === document.styleSheets[b].href && /ghostery-purple-box/.test(
